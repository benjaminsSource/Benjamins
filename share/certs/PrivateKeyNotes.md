...
unlocked to sign the Benjamins-Qt.app bundle.
...
allowing somebody to distribute a Benjamins-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the benjamins-qt.exe file inside the installer had not been tampered with.
