...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Benjamins " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Benjamins", "seed.benjaminsbaby.com"},
    {NULL, NULL}
};
...
static const char *strTestNetDNSSeed[][2] = {
    {"StableB", "95.85.39.131"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"StableC", "97.112.91.126"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"StableD", "67.233.200.130"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Benjamins is probably already running."), addrBind.ToString().c_str());
        else
